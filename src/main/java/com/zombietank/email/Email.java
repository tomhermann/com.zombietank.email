...
public class Email implements Serializable {
	...
	private final List<InternetAddress> to = new ArrayList<InternetAddress>();
	private final List<InternetAddress> cc = new ArrayList<InternetAddress>();
	private final List<InternetAddress> bcc = new ArrayList<InternetAddress>();
	...
	public Email to(Collection<InternetAddress> addresses) {
		to.addAll(addresses);
		return this;
	}
	...
	public Email cc(Collection<InternetAddress> addresses) {
		cc.addAll(addresses);
		return this;
	}
	...
	public Email bcc(Collection<InternetAddress> addresses) {
